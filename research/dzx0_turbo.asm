; -----------------------------------------------------------------------------
; ZX0 decoder by Einar Saukas & introspec  — "Turbo" version (126 bytes, 21% faster)
; VERBATIM from github.com/einar-saukas/ZX0 (z80/dzx0_turbo.asm).
;   HL: source (compressed)   DE: destination
; -----------------------------------------------------------------------------
dzx0_turbo:
