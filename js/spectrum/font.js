/**
 * ZX Spectrum ROM font — the exact 8x8 pixel bitmaps for characters 32-127.
 * 96 characters x 8 bytes each = 768 bytes.
 * Each byte represents one row of 8 pixels (MSB = leftmost pixel).
 *
 * Source: ZX Spectrum 48K ROM at offset 0x3D00.
 */
export const FONT_DATA = new Uint8Array([
    ...
    // 96: pound sign (Spectrum uses this instead of backtick)
